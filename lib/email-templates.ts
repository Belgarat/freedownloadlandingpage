...
// Template per email di follow-up (24-48 ore dopo)
export const getFollowUpEmailTemplate = (data: EmailTemplateData) => {
  const { 
    name = 'there', 
    downloadUrl, 
    bookTitle = 'Fish Cannot Carry Guns',
  ...
  return {
    subject: `Still interested in ${bookTitle}? Here's your fresh download link`,
    html: `
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Fresh Download Link</title>
      </head>
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #0f766e, #0891b2, #1e40af); padding: 30px; border-radius: 10px; color: white; text-align: center;">
          <h1 style="margin: 0 0 20px 0; font-size: 28px;">Fresh Download Link</h1>
          <p style="margin: 0; font-size: 18px;">Hi ${name}, here's your new download link for ${bookTitle}</p>
        </div>
        
        <div style="padding: 30px; background: #f8f9fa; border-radius: 0 0 10px 10px;">
          <h2 style="color: #0f766e; margin-top: 0;">Did you miss the first download?</h2>
          
          <p>Hi ${name},</p>
          
          <p>We noticed you might not have downloaded your free copy of <strong>${bookTitle}</strong> yet. No worries - here's a fresh download link that's good for another 24 hours!</p>
          ...
          <div style="text-align: center; margin: 30px 0;">
            ...
            <p style="font-size: 12px; color: #6b7280; margin-top: 10px;">
              ⏰ This fresh link expires in 24 hours
            </p>
          </div>
          ...
          <div style="background: #f0f9ff; border-left: 4px solid #0ea5e9; padding: 15px; margin: 20px 0; border-radius: 5px;">
            <h3 style="margin: 0 0 10px 0; color: #0c4a6e;">Support Independent Authors</h3>
            <p style="margin: 0 0 15px 0; color: #0c4a6e;">
              If you enjoyed the book, please support ${authorName}:
            </p>
            <ul style="margin: 0; padding-left: 20px; color: #0c4a6e;">
              <li><strong>Add to Goodreads:</strong> Mark "${bookTitle}" as "Read" on Goodreads</li>
              <li><strong>Leave a Review:</strong> Share your thoughts on Amazon or Goodreads</li>
              <li><strong>Subscribe:</strong> Follow <a href="https://aroundscifi.substack.com/" style="color: #0ea5e9;">Around Sci-Fi</a> for more stories</li>
            </ul>
            <div style="text-align: center; margin-top: 15px;">
              <a href="https://www.goodreads.com/book/show/237833382-fish-cannot-carry-guns" 
                 style="background: #0ea5e9; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-size: 14px; margin-right: 10px;">
          ...
          <div style="font-size: 14px; color: #6b7280;">
            ...
            <p style="margin-top: 30px; font-size: 12px; color: #9ca3af;">
              You received this email because you requested a free copy of "${bookTitle}". 
              If you don't want to receive follow-up emails, you can unsubscribe by replying with "STOP".
            </p>
          </div>
        </div>
      </body>
    ...
    `,
    text: `
Fresh Download Link - ${bookTitle}

Hi ${name},

We noticed you might not have downloaded your free copy of "${bookTitle}" yet. No worries - here's a fresh download link that's good for another 24 hours!
...
Download your free copy: ${downloadUrl}
⚠️ This fresh link expires in 24 hours

Support Independent Authors:
If you enjoyed the book, please support ${authorName} by:
- Adding "${bookTitle}" to your Goodreads "Read" list: https://www.goodreads.com/book/show/237833382-fish-cannot-carry-guns
- Leaving a review on Amazon: ${amazonUrl}
- Subscribing to Around Sci-Fi on Substack: https://aroundscifi.substack.com/
...
You received this email because you requested a free copy. If you don't want follow-up emails, reply with "STOP".
    `
  }
} 