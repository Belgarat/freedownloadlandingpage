-- Email Template Analytics (SQLite)
...
CREATE TABLE IF NOT EXISTS email_template_metrics (
    ...
    open_rate REAL DEFAULT 0.00,
    click_rate REAL DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS email_template_ab_tests (
    ...
    FOREIGN KEY (winner_template_id) REFERENCES email_templates(id) ON DELETE SET NULL
);
