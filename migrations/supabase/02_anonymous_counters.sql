-- Anonymous Counters Table (Supabase/PostgreSQL)
...
INSERT INTO anonymous_counters (key, total_visits, total_downloads, total_email_submissions, total_goodreads_clicks, total_substack_clicks, total_publisher_clicks)
